    ...
    <footer className="py-8 bg-zinc-950">
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center">
          {/* Sezione pulsanti social */}
          <div className="flex items-center gap-4">
            {/* Icona 1 - GitHub */}
            <div className="social-button">
              <button
                onClick={() =>
                  window.open("https://github.com/Davidetat1", "_blank")
                }
              ...
              >
                ...
                <div className="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-[#edeef0] rounded-full">
                  <svg
                    height="28"
                    width="28"
                    viewBox="0 0 24 24"
                  ...
                  >
                    <path
                      className="group-hover:fill-[#d2d2d8] fill-white duration-300"
            ...
            <div className="social-button">
              <button
                onClick={() =>
                  window.open(
                    "https://www.linkedin.com/in/davide-tatone/",
                    "_blank"
                  )
                }
                className="relative w-12 h-12 rounded-full group"
              >
                <div className="floater w-full h-full absolute top-0 left-0 bg-[#dadbdb] rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
                <div className="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-[#ffffff] rounded-full">
                  <svg
                    height="28"
                    width="28"
                    viewBox="0 0 24 24"
                  ...
                  >
                    <path
                      className="group-hover:fill-[#1880e0] fill-[#1880e0] duration-300"
            ...
            <div className="social-button">
              <button
                onClick={() =>
                  (window.location.href = "mailto:davidetatone92@gmail.com")
                }
                className="relative w-12 h-12 rounded-full group"
              >
                <div className="floater w-full h-full absolute top-0 left-0 bg-[#f52e2e] rounded-full duration-300 group-hover:-top-8 group-hover:shadow-2xl"></div>
                <div className="icon relative z-10 w-full h-full flex items-center justify-center border-2 border-[#f3f0f0] rounded-full">
                  <svg
                    height="28"
                    width="28"
                    viewBox="0 0 32 32"
                  ...
                  >
                    <path
                      className="group-hover:fill-[#e6e0e0] fill-[#fcfdff] duration-300"
          ...
          {/* Testo finale del footer */}
          <p className="text-white/80 text-sm mt-4">
            © 2025 Davide Tatone. Tutti i diritti riservati.
          </p>
        </div>
      </div>
    </footer>
